    ...
    class Meks_Video_Importer_Vimeo {
        ...
        public function ajax_save_settings() {
            ...
            if ( !wp_verify_nonce( $_POST['nonce'], 'ajax-nonce' ) ) {
                wp_send_json_error(array('message' => '<span class="dashicons dashicons-no"></span>' . __('Missing nonce.. Please try adding it again', 'meks-video-importer')));
            }
        ...
        public function ajax_fetch_from_vimeo() {
            ...
            if ( !wp_verify_nonce( $_POST['nonce'], 'ajax-nonce' ) ) {
                wp_send_json_error(array('message' => __('Missing nonce.', 'meks-video-importer')));
            }
