...
<tr class="form-field">
    ...
    <td>
        ...
        <p class="description"><?php echo wp_kses_post( __( 'Where can I <a href="https://mekshq.com/faq/vimeo-client-id-secret-video-importer-wordpress-plugin/" target="_blank">get Vimeo Client ID & Secret</a>?', 'meks-video-importer')); ?></p>
    </td>
</tr>