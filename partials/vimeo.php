    ...
    <td>
        <select name="mvi-vimeo-type" id="mvi-vimeo-type" data-type="vimeo-type">
            <?php foreach ($fetch_from_options as $key => $option) :?>
                <option value="<?php echo esc_attr($key); ?>" <?php echo meks_video_importer_selected($vimeo_options['mvi-vimeo-type'], $key); ?>><?php echo esc_html($option); ?></option>
            <?php endforeach; ?>
        </select>
    </td>
</tr>
...
<tr class="form-field type-change provider vimeo <?php echo meks_video_importer_selected($import_options['provider'], 'vimeo', 'active'); ?>">
    ...
    <td>
        ...
        <p class="description type-change vimeo-type user <?php echo meks_video_importer_selected($vimeo_options['mvi-vimeo-type'], 'user', 'active'); ?>">
            <small><?php echo wp_kses_post(__('Example: https://vimeo.com/<strong>SomeUser</strong>', 'meks-video-importer')); ?></small>
            <br>
            <small><?php echo wp_kses_post(__('User ID: <strong>SomeUser</strong>' , 'meks-video-importer')); ?></small>
        </p>
        ...
        <p class="description type-change vimeo-type group <?php echo meks_video_importer_selected($vimeo_options['mvi-vimeo-type'], 'group', 'active'); ?>">
            <small><?php echo wp_kses_post(__('Example: https://vimeo.com/groups/<strong>SomeGroup</strong>', 'meks-video-importer')); ?></small>
            <br>
            <small><?php echo wp_kses_post(__('Group ID: <strong>SomeGroup</strong>' , 'meks-video-importer')); ?></small>
        </p>
        <p class="description type-change vimeo-type channel <?php echo meks_video_importer_selected($vimeo_options['mvi-vimeo-type'], 'channel', 'active'); ?>">
            <small><?php echo wp_kses_post(__('Example: https://vimeo.com/channels/<strong>SomeChannel</strong>', 'meks-video-importer')); ?></small>
            <br>
            <small><?php echo wp_kses_post(__('Channel ID: <strong>SomeChannel</strong>' , 'meks-video-importer')); ?></small>
        </p>
    </td>
</tr>
...
<tr class="form-field type-change provider vimeo <?php echo meks_video_importer_selected($import_options['provider'], 'vimeo', 'active'); ?>">
    ...
    <td>
        <input class="smaller" id="mvi-vimeo-from-page" name="mvi-vimeo-from-page" type="number" value="<?php echo esc_attr($vimeo_options['mvi-vimeo-from-page']); ?>"> -
        <input class="smaller" id="mvi-vimeo-to-page" name="mvi-vimeo-to-page" type="number" value="<?php echo esc_attr($vimeo_options['mvi-vimeo-to-page']); ?>">
