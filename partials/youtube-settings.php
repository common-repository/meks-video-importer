...
<tr class="form-field">
    ...
    <td>
        ...
        <p class="description"><?php echo wp_kses_post( __( 'Where can I <a href="https://mekshq.com/faq/youtube-api-key-video-importer-wordpress-plugin/" target="_blank">get YouTube API key</a>?', 'meks-video-importer')); ?></p>
    </td>
</tr>