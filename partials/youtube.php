    ...
    <td>
        <select name="mvi-youtube-type" id="mvi-youtube-type" data-type="youtube-type">
            <?php foreach ($options as $key => $option) : ?>
                <option value="<?php echo esc_attr($key); ?>" <?php echo meks_video_importer_selected($youtube_options['mvi-youtube-type'], $key); ?>><?php echo esc_html($option); ?></option>
            <?php endforeach; ?>
        </select>
    </td>
</tr>
...
<tr class="form-field type-change provider youtube <?php echo meks_video_importer_selected($import_options['provider'], 'youtube', 'active'); ?>">
    ...
    <td>
        ...
        <p class="description type-change youtube-type playlist <?php echo meks_video_importer_selected($youtube_options['mvi-youtube-type'], 'playlist', 'active'); ?>" >
            <small><?php echo wp_kses_post( __('Example: https://www.youtube.com/watch?v=g72rFb6P13w&list=<strong>PL2acA3M-2dSTuk6tSUblX_P7A0Yxj_Xca</strong>' , 'meks-video-importer')); ?></small>
            <br>
            <small><?php echo wp_kses_post( __('Playlist ID: <strong>PL2acA3M-2dSTuk6tSUblX_P7A0Yxj_Xca</strong>' , 'meks-video-importer')); ?></small>
        </p>
        ...
        <p class="description type-change youtube-type channelId <?php echo meks_video_importer_selected($youtube_options['mvi-youtube-type'], 'channelId', 'active'); ?>">
            <small class=""><?php echo wp_kses_post( __('Example: https://www.youtube.com/channel/<strong>UCzs2Skg6P_9gdQGZo65YQTg</strong>', 'meks-video-importer')); ?></small>
            <br>
            <small><?php echo wp_kses_post( __('Channel ID: <strong>UCzs2Skg6P_9gdQGZo65YQTg</strong>' , 'meks-video-importer')); ?></small>
        </p>
        ...
        <p class="description type-change youtube-type search <?php echo meks_video_importer_selected($youtube_options['mvi-youtube-type'], 'search', 'active'); ?>">
            <small><?php echo wp_kses_post( __('Example: <strong>Meks WordPress Themes</strong>' , 'meks-video-importer')); ?></small>
        </p>
